...
protocol NavigationBarProtocol: ViewProtocol {
    var items: [NavigationItem]? { get }
}

public struct NavigationBar: IBDecodable, NavigationBarProtocol, IBIdentifiable {
    // MARK: UIView
    ...
    static func decode(_ xml: XMLIndexerType) throws -> NavigationBar {
        ...
        let containerNavigationItems = xml
            .container(keys: CodingKeys.self)
            .nestedContainerIfPresent(of: .items, keys: NavigationItemsCodingKeys.self)
